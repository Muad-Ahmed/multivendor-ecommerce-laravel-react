            ...
            <section className="grid gap-5 lg:grid-cols-[1fr_380px]">
                ...
                <aside className="fintech-panel rounded-xl p-6">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-slate-600 dark:text-slate-300">
                        <div className="flex justify-between"><span>Subtotal</span><span>$149</span></div>
                        <div className="flex justify-between"><span>Tax</span><span>TODO</span></div>
                        <div className="flex justify-between border-t border-slate-200 pt-3 font-black text-slate-950 dark:border-white/10 dark:text-white"><span>Total</span><span>TODO</span></div>
                    </div>
