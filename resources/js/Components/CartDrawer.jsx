                        ...
                        <div className="flex-1 overflow-y-auto py-5">
                            {cart.length === 0 ? (
                                <div className="flex h-full flex-col items-center justify-center text-center">
                                    ...
                                    <p className="mt-4 text-sm font-bold text-slate-500 dark:text-slate-400">سلتك فارغة حالياً</p>
                                    <p className="mt-2 text-xs text-slate-400 dark:text-slate-500">أضف بعض المنتجات الرائعة من المعرض لبدء التسوق!</p>
                                </div>
                            ) : (
                                <div className="space-y-4">
                                    ...
                                    {cart.map((item) => (
                                        ...
                                        >
                                            ...
                                            <div className={`h-16 w-16 flex-shrink-0 rounded-lg bg-gradient-to-br ${item.accent || 'from-cyan-400 to-lime-300'}`} />
                        ...
                        {cart.length > 0 && (
                            <div className="border-t border-slate-200 pt-5 dark:border-white/10 space-y-4">
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 leading-normal">
                                    * سيتم حساب الضرائب ومصاريف الشحن بشكل آمن في الخطوة التالية.
                                </p>
